...
const title = '项目放置库'
const description = '个人做了各种各样的小项目，和一些友情链接，这里是我能翻找到的，后面会持续更新。'
    ...
    <Container className="mt-16 sm:mt-32">
      <header className="max-w-2xl">
        ...
        <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
          ...
          <br/>
          下面是一些
          <strong className="underline decoration-2 underline-offset-4 decoration-wavy decoration-lime-500">曾经做过的项目</strong>,和一些有用的链接，如果你有兴趣的话,可以看看。
        </p>
      </header>
